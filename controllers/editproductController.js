...
exports.editproduct = async (req,res,next)=>{
    ...
    .then(function (image) {
        ...
        GameModel.updateGameByName(formfields.name,{ basePrice: formfields.basePrice, cover: formfields.cover, title: formfields.name, Description: formfields.description});
